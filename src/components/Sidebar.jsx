    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-100 font-sans">
      ...
      >
        ...
        <nav className="flex-1 p-3.5 space-y-2 overflow-y-auto">
          ...
          {!isAuthenticated ? (
            <>
              ...
              {/* Login / Auth Action Column right under routes */}
              <div className="pt-3 border-t border-gray-200 space-y-2">
                <div className="text-[11px] font-semibold uppercase tracking-wider text-gray-400 px-2">
                  Account Access
                </div>
                <NavLink
                  to="/login"
            ...
            <div className="space-y-1">
              ...
              <NavLink to="/complaints" onClick={() => setMobileDrawerOpen(false)} className={getNavLinkClass}>
                <Search className="h-4 w-4 shrink-0" strokeWidth={1.75} />
                <span>Public registry view</span>
              </NavLink>
            </div>
          ) : (
        ...
        <div className="p-3.5 border-t border-gray-200 bg-gray-50 space-y-2.5">
          {isAuthenticated && (
            <div className="px-2 py-1.5 bg-white rounded border border-gray-200">
        ...
        <nav className="flex-1 p-3 space-y-2 overflow-y-auto">
          {!isAuthenticated ? (
            <>
              ...
              {/* Login & Sign Up action buttons in column directly under routes */}
              <div className="pt-3 border-t border-gray-200 space-y-2">
                {!collapsed && (
                  <div className="text-[11px] font-semibold uppercase tracking-wider text-gray-400 px-2">
                    Account Access
            ...
            <div className="space-y-1">
              ...
              <NavLink
                to="/complaints"
                className={getNavLinkClass}
                title={collapsed ? 'Public registry view' : undefined}
              >
                <Search className="h-4 w-4 shrink-0" strokeWidth={1.75} />
                {!collapsed && <span className="truncate">Public registry view</span>}
              </NavLink>
            </div>
          ) : (
            <div className="space-y-2">
            ...
            <div>
              {!collapsed ? (
                <button
                  type="button"
                  onClick={handleSignOut}
                  className="w-full flex items-center justify-center gap-2 px-2.5 py-1.5 text-xs font-medium text-red-700 bg-red-50/70 hover:bg-red-100/80 border border-red-200 rounded transition-colors"
                >
                  <LogOut className="h-3.5 w-3.5" strokeWidth={1.75} />
                  <span>Sign out</span>
                </button>
